...
const addChildNode = (subNode, childNode, size = 50, distance = 100 ) => {  //default size for child node
...
const assembleChildNode = (subNode, id, articles) => { 
    ...
    for(let i=0; i<articles; i++) {
        addChildNode(childNode, { "id" : ""}, 20, 50) //pass the childnode abd the leave node //community -> 20 articles with no label, for leave node pass size
    }
};
